                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    <form action="card_c1.php" method="POST">
                                        <input type="hidden" value="c1.png" name="card">
                                        <button type="submit" class="btn btn-primary btn-lg">เลือก</button>
                                    </form>
                                </div>
                            </div>
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    <form action="card_c2.php" method="POST">
                                        <input type="hidden" value="c2.png" name="card">
                                        <button type="submit" class="btn btn-primary btn-lg">เลือก</button>
                                    </form>
                                </div>
                            </div>
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    <form action="card_c3.php" method="POST">
                                        <input type="hidden" value="c3.png" name="card">
                                        <button type="submit" class="btn btn-primary btn-lg">เลือก</button>
                                    </form>
                                </div>
                            </div>
