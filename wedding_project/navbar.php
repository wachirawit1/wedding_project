<nav class="navbar navbar-expand-lg py-3 navbar-light bg-white fixed-top">
    <a class="navbar-brand" href="index.php"><img src="assets/images/logo2.png" width="120px"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a href="login_store.php" class="nav-link" >เข้าสู่ระบบร้านค้า</a>
            </li>
            <li class="nav-item">
                <a href="login.php" class="btn px-4" style="color: grey;">สมัครสมาชิก/เข้าสู่ระบบ</a>
            </li>
