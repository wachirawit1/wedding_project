...
<body>
    ...
    <div class="card">
        <div class="py-3">
            <h1 class="display-4 text-center"><?= $row['p_name'] ?></h1>
        </div>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div id="full-gallery" class="content-slideshow" style="position: relative;margin: 0;top: 2px;margin-left: auto;margin-right: auto;width: 100%;height: 30rem;overflow: hidden;">
                        <div class="mibreit-imageElement" style="opacity:0">
                            <img src="img/<?= $row['picture'] ?>" data-src="img/<?= $row['picture'] ?>" data-title="Image 1" alt="Image 2" class="col-12" />
                        </div>
                        <?php if (!empty($row['gallery1'])) { ?>
                            <div class="mibreit-imageElement" style="opacity:0">
                                <img src="img/<?= $row['gallery1'] ?>" data-src="img/<?= $row['gallery1'] ?>" data-title="Image 1" alt="Image 2" class="col-12" />
                            </div>
                        <?php }
                        if (!empty($row['gallery2'])) {
                        ?>
                            <div class="mibreit-imageElement" style="opacity:0">
                                <img src="img/<?= $row['gallery2'] ?>" data-src="img/<?= $row['gallery2'] ?>" data-title="Image 1" alt="Image 2" class="col-12" />
                            </div>
                        <?php }
                        if (!empty($row['gallery3'])) {
                        ?>
                            <div class="mibreit-imageElement" style="opacity:0">
                                <img src="img/<?= $row['gallery3'] ?>" data-src="img/<?= $row['gallery3'] ?>" data-title="Image 1" alt="Image 2" class="col-12" />
                            </div>
                        <?php }
                        if (!empty($row['gallery4'])) {
                        ?>
                            <div class="mibreit-imageElement" style="opacity:0">
                                <img src="img/<?= $row['gallery4'] ?>" data-src="img/<?= $row['gallery4'] ?>" data-title="Image 1" alt="Image 2" class="col-12" />
                            </div>
                        <?php }
                        if (!empty($row['gallery5'])) {
                        ?>
                            <div class="mibreit-imageElement" style="opacity:0">
                                <img src="img/<?= $row['gallery5'] ?>" data-src="img/<?= $row['gallery5'] ?>" data-title="Image 1" alt="Image 2" class="col-12" />
                            </div>
                        <?php }
                        if (!empty($row['gallery6'])) {
                        ?>
                            <div class="mibreit-imageElement" style="opacity:0">
                                <img src="img/<?= $row['gallery6'] ?>" data-src="img/<?= $row['gallery6'] ?>" data-title="Image 1" alt="Image 2" class="col-12" />
                            </div>
                        <?php } ?>
                    </div>
