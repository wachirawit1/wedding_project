<nav class="navbar navbar-expand-lg py-3 navbar-light bg-white  sticky-top">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="traditional.php">จัดการประเพณี <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="admin_post.php">อนุมัติโพสต์ <span class="sr-only">(current)</span></a>
            </li>
